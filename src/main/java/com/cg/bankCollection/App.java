...
import com.cg.bank.uiesception.InvalidIDException;
import com.cg.bank.uiesception.InvalidInputException;
import com.cg.bank.uiesception.TransactionException;
import com.cg.bank.uiesception.WithDrawlException;
...
public class App {
	...
	long amt = 0, res = 0;
		...
		case 2:
			...
			amt = sc.nextLong();
			res = custservice.withdrawl(customer,amt);
			if (res != 0)
				System.out.println("Balance is" + res);
			else
				try {
			...
			break;
		case 3:
			res = custservice.dispBal(customer,amt);
			System.out.println("Balance is" + res);
			break;
